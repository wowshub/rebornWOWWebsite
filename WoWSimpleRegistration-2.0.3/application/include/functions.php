...
function GetCaptchaHTML($bootstrap = true)
{
    ...
    if (empty($bootstrap)) {
        return '<div class="input-group"><input type="text" placeholder="' . lang('captcha') . '" name="captcha"></div><p style="text-align: center;margin-top: 10px;"><img src="captcha.php" onclick="this.src=\'captcha.php?\' + Math.random();" style="border-radius: 5px; cursor: pointer;" title="点击刷新验证码" /></p>';
    }

    return '<div class="input-group"><span class="input-group">' . lang('captcha') . '</span><input type="text" class="form-control" placeholder="' . lang('captcha') . '" name="captcha"></div><p style="text-align: center;margin-top: 10px;"><img src="captcha.php" onclick="this.src=\'captcha.php?\' + Math.random();" style="border-radius: 5px; cursor: pointer;" title="点击刷新验证码" /></p>';
}
