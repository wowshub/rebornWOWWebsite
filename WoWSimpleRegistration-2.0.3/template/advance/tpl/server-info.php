            ...
            <div class="row">
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="content pt-4 pt-lg-0 pl-0 pl-lg-3 ">
                        ...
                        <ul>
                            <li><i class="bx bx-check-double"></i><?php elang('server_type'); ?>: <b>Blizzlike 多种族 玩家机器人 NPC机器人 暗黑三巅峰系统...</b></li>
                            ...
                            <li><i class="bx bx-check-double"></i><?php elang('max_level'); ?>: <b>80-255</b></li>
                            <li><i class="bx bx-check-double"></i><?php elang('fixed_spells'); ?>: <b>99.9%</b></li>
                            <li><i class="bx bx-check-double"></i><?php elang('fixed_dungeons'); ?>: <b>99.9%</b></li>
                            <li><i class="bx bx-check-double"></i><?php elang('fixed_instances'); ?>: <b>99.9%</b></li>
                        </ul>
                        <p>
