                    ...
                    <div style="padding: 10px;" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <?php if (!get_config('battlenet_support')) { ?>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" pattern="[A-Za-z0-9_-]{2,16}" required placeholder="<?php elang('username'); ?>"
                                       name="username">
                            </div>
                        <?php } ?>
                        <div class="input-group">
...
<section id="playermap" class="services">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>玩家地图</h2>
            <p>实时查看在线玩家位置</p>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
             <div class="col-lg-12">
                 <iframe src="map/index.php" style="width:100%; height:1000px; border:none;"></iframe>
             </div>
        </div>
    </div>
</section>
