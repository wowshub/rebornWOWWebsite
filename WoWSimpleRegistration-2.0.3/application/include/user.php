...
class user
{
    ...
    public static function post_handler()
    {
        ...
        if (!empty($_POST['submit'])) {
            ...
            if (empty(get_config('captcha_type'))) {
                ...
                self::$captcha = new CaptchaBuilder($phrase);
                self::$captcha->build();
    ...
    public
        static function get_user_by_email(
        $email
    ) {
        if (!empty($email)) {
     ...
     */
    public
        static function check_username_exists(
        $username
    ) {
        if (!empty($username)) {
    ...
    public
        static function get_online_players(
        $realmID
    ) {
    ...
    public
        static function get_online_players_count(
        $realmID
    ) {
